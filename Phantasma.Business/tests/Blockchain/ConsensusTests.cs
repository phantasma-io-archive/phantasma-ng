...
public class ConsensusTests
{
    ...
    private void CreateValidators()
    {
        ...
        for (int i = 2; i < validatorKeyPairs.Length; i++)
        {
            ...
            Assert.True(validatorType != Invalid);
        }
    ...
    private void AddNewValidator(PhantasmaKeys newValidator)
    {
        ...
        var votingRank = simulator.InvokeContract(ConsensusContractName, nameof(ConsensusContract.GetRank), pollName,
        ...
        for (int i = 0; i <= activeValidatorCount; i++)
        {
            ...
            votingRank = simulator.InvokeContract(ConsensusContractName, nameof(ConsensusContract.GetRank), pollName, validatorChoice).AsNumber();
