...
public class RelayTests
{
    ...
    //    Assert.True(channelBalance == desiredChannelBalance);            
    //}
    ...
    //    
    //    Assert.True(receipts.values.Length == messageCount);

    //    for (int i = 0; i < messageCount; i++)
    //    {
    //        var obj = receipts.values[i];
    //        Assert.True(obj is ReceiptResult);

    //        var receiptResult = (ReceiptResult) obj;
    //        Assert.True(receiptResult.nexus == messages[i].nexus);
    //        Assert.True(new BigInteger(receiptResult.index, 10) == messages[i].index);
    //        //Assert.True(receiptResult.receiver == messages[i].receiver);
    //        //Assert.True(receiptResult.script == messages[i].script);
    //        //Assert.True(receiptResult.sender == messages[i].sender);
    //        Assert.True(receiptResult.timestamp == messages[i].timestamp);
    //    }
    //}
    ...
    //    Assert.True(senderFinalBalance == senderInitialBalance - txCost);
    //    Assert.True(receiverFinalBalance == receiverInitialBalance + (expectedFee / 2));
    //    Assert.True(chainFinalBalance == chainInitialBalance - (expectedFee / 2));    //the sender's balance is escrowed in the chain address, so the chain just sends the other half of the fee away to the receiver
    //}
    ...
    public void TestMessageInterception()
    {
        ...
        Assert.True(receipts.values.Length == 1);
