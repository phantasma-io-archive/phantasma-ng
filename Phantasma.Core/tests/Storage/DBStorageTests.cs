...
public class DBStorageTests
{
    ...
    public void TestDBStorageVisit()
    {
        ...
        Assert.True(keyList.Count == valueList.Count);
    }

    [Fact]
    // TODO This test fails sometimes on first "Assert.True(testMap.Count() == 0);" check.
    ...
    public void TestDBStorageAllValuesEmpty()
    {
        ...
        Assert.True(testMap.AllValues<BigInteger>().Length == 0);
        ...
        testMap.Set(2, 2);
        testMap.Set(3, 2);
        Assert.True(testMap.AllValues<BigInteger>().Length == 3);
    }
