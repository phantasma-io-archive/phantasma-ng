...
public interface INexus
{
    ...
    Task<byte[]> LookUpAddressScript(StorageContext storage, Address address);
    Task<bool> HasAddressScript(StorageContext storage, Address address);
    ...
    Task MintToken(IRuntime Runtime, IToken token, Address source, Address destination, string sourceChain, BigInteger tokenID);
    Task MintTokens(IRuntime Runtime, IToken token, Address source, Address destination, string sourceChain, BigInteger amount);
    ...
    Task BurnTokens(IRuntime Runtime, IToken token, Address source, Address destination, string targetChain, BigInteger amount);
    Task BurnToken(IRuntime Runtime, IToken token, Address source, Address destination, string targetChain, BigInteger tokenID);
    Task InfuseToken(IRuntime Runtime, IToken token, Address from, BigInteger tokenID, IToken infuseToken, BigInteger value);
    Task TransferTokens(IRuntime Runtime, IToken token, Address source, Address destination, BigInteger amount, bool isInfusion = false);
    Task TransferToken(IRuntime Runtime, IToken token, Address source, Address destination, BigInteger tokenID, bool isInfusion = false);
    ...
    Task<ValidatorType> GetValidatorType(Address address);
    ...
    Task<BigInteger> GetStakeFromAddress(StorageContext storage, Address address);
    Task<BigInteger> GetUnclaimedFuelFromAddress(StorageContext storage, Address address);
    Task<Timestamp> GetStakeTimestampOfAddress(StorageContext storage, Address address);
    Task<bool> IsStakeMaster(StorageContext storage, Address address);
    Task<int> GetIndexOfValidator(Address address);
    ...
    Task<BigInteger> GetRelayBalance(Address address);
