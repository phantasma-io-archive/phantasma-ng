...
screen -S node1p -dm bash -c 'cd /app/testnet/node1/publish/; dotnet phantasma-node.dll --urls "http://*:5102"; exec sh'
screen -S node2p -dm bash -c 'cd /app/testnet/node2/publish/; dotnet phantasma-node.dll --urls "http://*:5103"; exec sh'
screen -S node3p -dm bash -c 'cd /app/testnet/node3/publish/; dotnet phantasma-node.dll --urls "http://*:5104"; exec sh'
