...
namespace Phantasma.Node.Oracles
{
    public static class CoinGeckoUtils
    {
        ...
        public static decimal GetFromMarketChartRange(Timestamp time, string baseSymbol, string quoteSymbol,
            string baseticker)
        {
            ...
            var url =
                $"https://api.coingecko.com/api/v3/coins/{baseticker}/market_chart/range?vs_currency={quoteSymbol}&from={from.Value}&to={time.Value}";
