...
using Phantasma.Node.Models.Enums;
...
namespace Phantasma.Node
{
    public class Node : Runnable
    {
        ...
        public EthAPI BscAPI
        {
            get { return _bscAPI; }
        }

        public string CryptoCompareAPIKey
        {
            get { return _cryptoCompareAPIKey; }
        }

        public PhantasmaKeys NodeKeys
        {
        ...
        public Node()
        {
            ...
            this.ABCIConnector = new ABCIConnector(Settings.Instance.Node.SeedValidators, Settings.Instance.Validators,
                this.NodeConnector, Settings.Instance.Node.MinimumFee);
        }
        ...
        protected override void OnStart()
        {
            ...
            Console.CancelKeyPress += delegate { this.Terminate(); };
            ...
            _tendermint_RPC_URL = Settings.Instance.Node.TendermintRPCHost + ":" +
                                  Settings.Instance.Node.TendermintRPCPort;
            _tendermint_Proxy_URL = Settings.Instance.Node.TendermintProxyHost + ":" +
                                    Settings.Instance.Node.TendermintProxyPort;
            ...
            var server = new Server(options)
            {
                Ports =
                {
                    new ServerPort(Settings.Instance.Node.TendermintProxyHost,
                        Settings.Instance.Node.TendermintProxyPort
            ...
            SetupTendermint(Settings.Instance.Node.TendermintPath);
        ...
        {
            return url.Replace("http://", "", StringComparison.OrdinalIgnoreCase)
        ...
        /// Setup Tendermint
        /// </summary>
        /// <param name="tendermintPath"></param>
        /// <returns></returns>
        private bool SetupTendermint(string tendermintPath)
        {
            if (string.IsNullOrEmpty(tendermintPath))
            {
                return false;
            }
            
            LaunchTendermint(tendermintPath);
            return true;
        }
        ...
        private bool LaunchTendermint(string tendermintPath)
        {
            ...
            {
                _tendermintHome = Path.GetDirectoryName(Assembly.GetEntryAssembly().Location) +
                                  Path.DirectorySeparatorChar + "tendermint";
            }
        ...
        /// <summary>
        /// Patch tendermint priv_validator_key.json
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Patch Tendermint genesis.json file
        /// </summary>
        /// <returns></returns>
  ...
  ""validators"": [");
        ...
        private bool RunTendermint(string tendermintPath, string launchArgs)
        {
            ...
            new Thread(() => { DumpStream(_tendermintProcess.StandardOutput); }).Start();
