...
namespace Phantasma.LegacyTests
{
    public class CryptoTests
    {
        ...
        public void HashClass()
        {
            ...
            Assert.True(hash.ToByteArray().Length == 32);
            Assert.True(hash.ToByteArray().SequenceEqual(bytes));
            ...
            Assert.True(number == other);

            Assert.True(Hash.TryParse("FFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBB", out hash));
            Assert.True(Hash.TryParse("0xFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBB", out hash));
            Assert.False(Hash.TryParse("FFFFAAAXFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBB", out hash));
            Assert.False(Hash.TryParse("0xFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBBBFFFFAAAAFFFFBBB", out hash));
        }
        ...
        public void EdDSA()
        {
            ...
            Assert.False(otherKeys.Address == targetAddress);
