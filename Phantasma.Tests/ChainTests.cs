...
namespace Phantasma.Tests
{
    ...
    public class ChainTests
    {
        ...
        public void QuoteConversions()
        {
            ...
            var runtime = new RuntimeVM(-1, new byte[0], 0, nexus.RootChain, Address.Null, Timestamp.Now, Transaction.Null, context, new OracleSimulator(nexus), ChainTask.Null, true);
